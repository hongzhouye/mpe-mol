...
def read_aux_basis(fname):
    ...
    for i in range(nshells):
        ...
        if (len(line.split()) == 5):
            ...
            auxbas.append(
                map(int, line.split()[0:3])+map(float, line.split()[3:5]))
        else:
            auxbas.append(
                map(int, line.split()[0:2])+map(float, line.split()[2:4]))
...
def read_core_ints(fname, modims):
    ...
    for i in range(0, modims//7*7, 7):
        ...
        for j in range(modims):
            ...
            tmpline = f.readline()
            line = []
            line.append(tmpline[:5])
            line = line+re.findall(r"[-+]?\d{0,5}\.\d{5}", tmpline[5:])
            core[(int(line[0])-1), (i+0):(i+7)] = [float(line[k])
                                                   for k in range(1, 8)]
    ...
    if(modims % 7):
        ...
        for j in range(modims):
            line = f.readline().rstrip().split()
            core[(int(line[0])-1), (i+0):(i+rest)] = [float(line[k])
...
def read_nuc_ints(fname, modims):
    ...
    for i in range(0, modims//7*7, 7):
        ...
        for j in range(modims):
            ...
            line.append(tmpline[:5])
            line = line+re.findall(r"[-+]?\d{0,5}\.\d{5}", tmpline[5:])
            nuc[(int(line[0])-1), (i+0):(i+7)] = [float(line[k])
                                                  for k in range(1, 8)]
    ...
    if(modims % 7):
        ...
        for j in range(modims):
            line = f.readline().rstrip().split()
            nuc[(int(line[0])-1), (i+0):(i+rest)] = [float(line[k])
                                                     for k in range(1, rest+1)]
...
def read_kin_ints(fname, modims):
    ...
    for i in range(0, modims//7*7, 7):
        ...
        for j in range(modims):
            ...
            line.append(tmpline[:5])
            line = line+re.findall(r"[-+]?\d{0,5}\.\d{5}", tmpline[5:])
            kin[(int(line[0])-1), (i+0):(i+7)] = [float(line[k])
                                                  for k in range(1, 8)]
    ...
    if(modims % 7):
        ...
        for j in range(modims):
            line = f.readline().rstrip().split()
            kin[(int(line[0])-1), (i+0):(i+rest)] = \
                [float(line[k]) for k in range(1, rest+1)]
...
def read_overlap_ints(fname, modims):
    ...
    for i in range(0, modims//5*5, 5):
        ...
        for j in range(modims):
            line = f.readline().rstrip().split()
            smat[(int(line[0])-1), (i+0):(i+5)] = [float(line[k])
                                                   for k in range(1, 6)]
...
def read_dip_ints(fname, modims, x, y, z):
    ...
    for i in range(0, modims//7*7, 7):
        ...
        for j in range(modims):
            line = f.readline().rstrip().split()
            dip[(int(line[0])-1), (i+0):(i+7)] = [float(line[k])
                                                  for k in range(1, 8)]
    ...
    if(modims % 7):
        ...
        for j in range(modims):
            line = f.readline().rstrip().split()
            dip[(int(line[0])-1), (i+0):(i+rest)] = [float(line[k])
                                                     for k in range(1, rest+1)]
